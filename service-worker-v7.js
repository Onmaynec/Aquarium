'use strict';
const CACHE='living-aquarium-v7.0.0';
const CORE=['./','./index.html','./styles.css','./app.js','./v7-expedition.js','./manifest.webmanifest','./assets/manifest.js','./assets/icon-192.png','./assets/icon-512.png'];
