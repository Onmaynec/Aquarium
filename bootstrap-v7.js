(async()=>{
  ...
  try{
    ...
    html=html.replace(/<title>[^<]*<\/title>/,'<title>Living Aquarium V7 Deep Sea Expedition</title>');
    html=html.replace('<link rel="stylesheet" href="styles.css">','<style>'+css+'</style>');
    html=html.replace('<script src="app.js"></script>','<script>'+app+'</script><script src="v7-expedition.js"></script>');
